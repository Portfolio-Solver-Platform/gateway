...
```
<IP> local harbor.local keycloak.local grafana.local secrets.local 
```
...
- `secrets.local` to [the secrets manager](https://github.com/Portfolio-Solver-Platform/secrets-manager)
- `harbor.local` to [the artifact registry](https://github.com/Portfolio-Solver-Platform/solver-artifact-registry)
